...
After successfully [building and packaging](https://github.com/mattermost/mattermost-developer-documentation/blob/master/site/content/contribute/desktop/developer-setup.md/#building) the Mattermost Desktop application for Windows, you can run the signing command from the root of the repository:
```bash
...
#### Signing the Release
Note that once the code signing certificate and private key have been imported as described in the **Prerequisites** section above, the application will automatically be code signed during [building and packaging](https://github.com/mattermost/mattermost-developer-documentation/blob/master/site/content/contribute/desktop/developer-setup.md/#building). To confirm that this step has been completed, skip down to the **Verifying the Signature** section below.
