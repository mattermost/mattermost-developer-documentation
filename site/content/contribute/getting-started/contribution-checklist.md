...
2. Your ticket is a Help Wanted GitHub issue for the Mattermost project you're contributing to.
    - If not, follow the process [here]({{< ref "/contribute/getting-started/contributions-without-ticket" >}}).
3. Your code is thoroughly tested, including appropriate unit tests, [end-to-end tests for webapp]({{< ref "/contribute/webapp/e2e" >}}), and manual testing.
