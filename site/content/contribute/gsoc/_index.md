...
2. Learn about our [contribution process]({{< ref "/contribute/getting-started" >}}). We encourage applicants to participate in one of the many contribution opportunities we have prior to applying.
3. Review our idea list below for any that might interest you, all of the details are listed [in GitHub Issues on our Community repository](https://github.com/mattermost/community/issues?q=is%3Aissue+is%3Aopen+label%3AGSoC).
4. Communicate! 
