...
3. Your code is thoroughly tested, including appropriate unit tests, [end-to-end tests for webapp]({{<relref "contribute/more-info/webapp/e2e-testing.md">}}), and manual testing.
