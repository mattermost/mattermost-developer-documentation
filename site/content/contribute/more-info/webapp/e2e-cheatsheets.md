...
If you need more help, check out the {{< newtabref href="https://testing-playground.com/" title="online Testing Playground" >}}—no install required, always up-to-date, and it teaches you the exact Testing-Library queries you should be using as you click through the DOM. And if you’d rather stay in your editor, check out the {{< newtabref href="https://marketplace.visualstudio.com/items?itemName=aganglada.vscode-testing-playground" title="VS Code Testing Playground" >}} extension, which brings the same interactive query suggestions and best-practice guidance right into your IDE.
