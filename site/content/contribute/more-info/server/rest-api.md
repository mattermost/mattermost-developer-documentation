...
4.  (Optional) Use `curl` or [Postman](https://www.getpostman.com/) to test the basics of your endpoint. The endpoint will also be tested [through a unit test]({{< ref "/contribute/more-info/server/rest-api#writing-a-unit-test" >}}), so this step is optional.
