...
7. Start the server:
    ...
    **Note:** If you see lot of `nc: bad address 'elasticsearch'` messages, eventually exiting with the message `Service elasticsearch:9200 did not start within 300 seconds. Aborting...`,  increase the memory available for the Docker Engine by going to {{< newtabref href="https://docs.docker.com/desktop/settings/mac/#advanced" title="Docker's preferences -> Advanced" >}}.
