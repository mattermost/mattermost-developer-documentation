...
#### Breaking Changes
All these great changes will require changes to any plugins built for pre-5.2 versions of Mattermost. See our [migration guide](https://developers.mattermost.com/integrate/plugins/migration/) for steps on how to update your plugins.
...
#### Documentation
For the full documentation on plugins, see [developers.mattermost.com/integrate/plugins](https://developers.mattermost.com/integrate/plugins/).
