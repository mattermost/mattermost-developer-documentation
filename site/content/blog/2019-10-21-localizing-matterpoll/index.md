...
The [Mattermost Server](https://github.com/mattermost/mattermost-server) uses the [go-i18n package](https://github.com/nicksnyder/go-i18n). The library is well maintained and very popular, which gave me confidence in using it.
...
If we e.g. want to add support for german, which has the language code `de`, we have to:

1. Create it's own file: `touch assets/i18n/translate.de.json`
