...
```
In short the above is how the whole thing started, really interesting how people from all over the 
globe attended the event, it was fun, a learning experience and even the unexpected was waiting on us. 
The first day began and all those stranger faces were getting a bit more familiar as 
...
[Here is a complete list of unsupported features]([https://github.com/facebook/hermes/blob/master/doc/Features.md#excluded-from-support](https://github.com/facebook/hermes/blob/master/doc/Features.md#excluded-from-support)).
