...
This manifest gives the server the location of your components within your plugin bundle. Consult the [manifest reference](/integrate/plugins/manifest-reference.md) for more details, including how to define a minimum required server version for your plugin.
