...
Looking for a quick start? [See our "Hello, world!" tutorial](/integrate/plugins/webapp/hello-world/).

Want the web app plugin reference doc? [Find it here](/integrate/plugins/webapp/reference/).
...
For example, you can register a custom post type `custom_poll` using [registerPostTypeComponent](/integrate/plugins/webapp/reference/#registerPostTypeComponent). Then, any time the web app sees that post type, it replaces the regular rendering of the post component with your own custom implementation.
