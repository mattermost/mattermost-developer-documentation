...
Yes. They can be packaged as "customer-deployable" bundles and then deployed on the supported serverless platforms, or ran as HTTP services on the organization's own hosting infrastructure.
