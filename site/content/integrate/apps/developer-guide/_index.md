...
| install | Call | The call to be made when the app gets enabled. By default invoke "/install", expanding App, AdminAccessToken, and Config. |
...
location
string
Name of this location. The whole path of locations will be added in the context.
icon
string
...
label
string
Text to show in the item on mobile and webapp collapsed view.
hint
string
...
location
string
The label to use to define the command.
hint
string
(Optional) Hint line on command autocomplete.
description
string
(Optional) Description line on command autocomplete.
bindings
Bindings
List of subcommands.
...
call
Call
Call to perform when executing the command
form
Form
...
title
string
Title of the form, shown in the modal.
header
string
(Optional) Text used as introduction in the form.
submit_buttons
string
(Optional) Key of the field to be used as the submit buttons. Must be of type static_select.
fields
Fields
...
is_required
bool
(Optional) Whether the field needs to be filled.
value
value
(Optional) Default value.
description
string
(Optional) Text to show below the field describing it.
modal_label
string
(Optional) Label to name the field in the modal.
...
subtype
string
(Optional) The type of text that will be shown. Available types are one of text, textarea, email, number, password, tel, or url.
min_length
int
(Optional) Validate the field length before performing the call.
max_length
int
(Optional) Validate the field length before performing the call.
...
refresh
bool
(Optional) Allows the form to be refreshed when the value of a dropdown is changed.
...
call
Call
(Optional) Call to perform on all actions form related (including submit). If not provided, will use the command binding call.
...
name
string
Key to use in the Values field of the call, and as part of the command.
type
FieldType
The type of the field.
is_required
bool
Whether the field needs to be filled.
description
string
Text to show on the description line on autocomplete.
hint
string
Text to show on the hint line on autocomplete.
label
string
Label to name the field in autocomplete.
...
location
string
Location name. The whole location path will be provided in the context.
label
string
Label that will show in the button.
call
Call
Call to be made when the button is clicked.
...
call
Call
(Optional) Call to be made when the button is clicked. If none is provided, all options must include a call.
bindings
Binding
...
location
string
Option name. The whole location path will be provided in the context.
label
string
User facing string.
call
