...
| `remote_webhook_auth_type`                                   | string                      | Specifies how incoming App [webhook]({{<ref "/integrate/apps/functionality/external-webhooks/">}}) messages from remote systems should be authenticated by Mattermost. One of `none`, `secret`, or `jwt`. Default value: `none` |
