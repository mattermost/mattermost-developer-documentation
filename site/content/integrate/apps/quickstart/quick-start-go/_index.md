...
In the same [mattermost-app-examples repository](https://github.com/mattermost/mattermost-app-examples) you cloned via the [developer setup guide]({{< ref "/integrate/apps/quick-start-developer-setup" >}}) above, navigate to the `golang/hello-world` directory and start the Docker compose:
