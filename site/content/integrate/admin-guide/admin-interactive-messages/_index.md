...
As an advanced feature, you can also use plugins to update the contents of an ephemeral message with message buttons or menus with the [UpdateEphemeralMessage plugin API](https://developers.mattermost.com/integrate/plugins/server/reference/#API.UpdateEphemeralPost).
