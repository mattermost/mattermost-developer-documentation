...
| response\_type | Set to `ephemeral` to reply with a message that only the user can see. <br> Set to blank or `in_channel` to create a regular message.<br> Defaults to `in_channel`. | No |
