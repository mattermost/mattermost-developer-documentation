...
| skip_slack_parsing | Signals mattermost that the post is correctly escaped for mattermost and the Slack-compatibility logic should be skipped. Useful if the post contains code which is incorrectly mangled by the Slack-compatibility logic. | No |
