...
Plugins can create bot accounts through an `EnsureBot` helper function. For an example, see {{< newtabref href="https://github.com/mattermost/mattermost-plugin-demo/blob/main/server/configuration.go#L210-L217" title="the Demo Plugin" >}}.
