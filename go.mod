...
require (
	// mmgoget: github.com/mattermost/mattermost-server/v6@v7.9.6 is replaced by -> github.com/mattermost/mattermost-server/v6@d0e672d94d
	github.com/mattermost/mattermost-server/v6 v6.0.0-20230705082526-d0e672d94dee
